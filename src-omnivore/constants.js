...
export const OMNIVORE_DASHBOARD_COLUMNS_SETTING = 'Omnivore dashboard columns (comma separated list of: "Author", "Description", "UpdatedAt", "SavedAt", "PageType", "ReadingProgressPercent")';
...
// Other constants
export const OMNIVORE_PLUGIN_VERSION = "1.0.2";
